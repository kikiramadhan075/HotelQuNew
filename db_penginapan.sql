...
insert into `tbl_kamar` (`id_kamar`,`id_tipe_kamar`,`deskripsi`,`status`) values (3,1,'Dilengkapi dengan AC, double bad, shower, dan televisi','N');
...
insert into `tbl_menu` (`id_menu`,`nama`,`harga`) values (10,'',0);
...
insert into `tbl_pembayaran` (`id_pembayaran`,`id_reservasi`,`id_tamu`,`id_kamar`,`id_tipe_kamar`,`id_user`,`total_bayar`,`bulan`,`tahun`) values (3,6,2,3,2,1,1318000,'1','2011');
insert into `tbl_pembayaran` (`id_pembayaran`,`id_reservasi`,`id_tamu`,`id_kamar`,`id_tipe_kamar`,`id_user`,`total_bayar`,`bulan`,`tahun`) values (4,7,2,5,2,2,428000,'1','2011');
...
insert into `tbl_pesanan` (`id_pesanan`,`id_reservasi`,`id_menu`,`jumlah_pesanan`,`tgl`) values (8,7,1,2,'29/01/2011');
insert into `tbl_pesanan` (`id_pesanan`,`id_reservasi`,`id_menu`,`jumlah_pesanan`,`tgl`) values (9,7,8,2,'29/01/2011');
...
insert into `tbl_reservasi` (`id_reservasi`,`id_tamu`,`id_user`,`id_tipe_kamar`,`id_kamar`,`tgl_cek_in`,`tgl_cek_out`,`lama_menginap`,`status`) values (6,2,2,1,3,'23/01/2011','29/01/2011','6','Y');
insert into `tbl_reservasi` (`id_reservasi`,`id_tamu`,`id_user`,`id_tipe_kamar`,`id_kamar`,`tgl_cek_in`,`tgl_cek_out`,`lama_menginap`,`status`) values (7,2,2,2,5,'29/01/2011','30/01/2011','1','Y');
...
/* Procedure structure for procedure `LihatTamu` */

drop procedure if exists `LihatTamu`;

DELIMITER $$

CREATE DEFINER=`root`@`localhost` PROCEDURE `LihatTamu`()
BEGIN
...
/* Procedure structure for procedure `LihatTipe` */

drop procedure if exists `LihatTipe`;

DELIMITER $$

CREATE DEFINER=`root`@`localhost` PROCEDURE `LihatTipe`()
BEGIN
